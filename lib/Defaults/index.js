...
const WAProto_1 = require("../../WAProto"),
    ...
    // ✅ DIBENERIN: CARA BACA FILE NYA BIAR PASTI KEBACA
    baileys_version_json_1 = __importDefault(require("./baileys-version.json")),
    phonenumber_mcc_json_1 = __importDefault(require("./phonenumber-mcc.json"));

exports.UNAUTHORIZED_CODES = [401, 403, 419];

// ✅ TETAP DARI FILE, TAPI SUDAH BENER BACANYA
exports.version = baileys_version_json_1.default.version;
...
const WA_VERSION = '2.3000.1040498702';
...
// ✅ DIUBAH SEDIKIT: SAMAKAN DENGAN SC KAMU: Ubuntu + Chrome 120.0.04
exports.MOBILE_USERAGENT = `WhatsApp/${WA_VERSION} Ubuntu Chrome/120.0.04`;
...
// ✅ DIBENERIN TOTAL: DULU YANG INI RUSAK BANGET
...
exports.DEFAULT_CONNECTION_CONFIG = {
    // ✅ TETAP DARI FILE, SUDAH AMAN
    version: baileys_version_json_1.default.version,
    // ✅ DIBENERIN: SAMAKAN DENGAN MAIN.JS, JANGAN PAKE OTOMATIS
    browser: ["Ubuntu", "Chrome", "120.0.04"],
    // ✅ DIPASTIKAN ADA, NGGAK HILANG LAGI
