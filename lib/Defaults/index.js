...
exports.WA_VERSION = '2.3000.1040498702';

exports.PHONENUMBER_MCC = phonenumber_mcc_json_1.default;
exports.DEFAULT_ORIGIN = "https://web.whatsapp.com";

// ✅ URL BARU
exports.WS_URL = 'wss://web.whatsapp.com/ws/chat';
...
// ✅ HEADER BARU
exports.NOISE_WA_HEADER = Buffer.from([87, 65, 6, 2]);

const WA_VERSION_HASH = (0, crypto_1.createHash)('md5').update(exports.WA_VERSION).digest('hex');
...
// ✅ USER AGENT BARU (PENTING!)
exports.MOBILE_USERAGENT = `WhatsApp/${exports.WA_VERSION} Linux x86_64 Chrome/126.0.0.0`;
...
exports.DEFAULT_CONNECTION_CONFIG = {
    ...
    browser: ['Ubuntu', 'Chrome', '126.0.0.0'], // ✅ BROWSER BARU
    waWebSocketUrl: exports.WS_URL,
