...
const makeSocket = (config) => {
    ...
    // ✅ UBAH BAGIAN URL: Pakai alamat resmi WA Web terbaru
    let url = typeof waWebSocketUrl === 'string' ? new url_1.URL(waWebSocketUrl) : waWebSocketUrl;
    url = new url_1.URL("wss://web.whatsapp.com/ws/chat"); // ✅ GANTI URL DI SINI
    ...
    /** ✅ UBAH NOISE HEADER: Pakai protokol versi terbaru */
    const noise = (0, Utils_1.makeNoiseHandler)({
        keyPair: ephemeralKeyPair,
        NOISE_HEADER: Buffer.from([87, 65, 6, 2]), // ✅ GANTI HEADER DI SINI
        logger,
    ...
    const validateConnection = async () => {
        // ✅ UBAH HELLO MESSAGE: Masukkan versi WA yang sama persis
        let helloMsg = {
            clientHello: { 
                ephemeral: ephemeralKeyPair.public,
                version: [2, 3000, 1040498702] // ✅ VERSI SAMA DENGAN FILE LAIN
            }
        };
    ...
    async function generatePairingKey() {
        ...
        const randomIv = (0, Utils_1.randomBytes)(16);
