...
const makeSocket = (config) => {
    ...
    // ✅ TETAP PAKAI ALAMAT YANG KAMU UBAH SENDIRI
    ...
    // ✅ KEMBALI PERSIS ASLI — TIDAK DIUBAH APA‑APA
    ...
    // ✅ DIPERBAIKI TEPAT — HANYA BAGIAN INI YANG DISESUAIKAN
    const onMessageReceived = (data) => {
        noise.decodeFrame(data, frame => {
            ...
            if (!(frame instanceof Uint8Array)) {
                // ✅ UBAH KE FORMAT PESAN SAH PAKAI FUNGSI YANG SUDAH ADA
                const pesanRapi = (0, Utils_1.toFullyQualifiedMessage)(frame);
                if (pesanRapi) {
    ...
    // ✅ KEMBALI PENUH ASLI — TIDAK ADA PERUBAHAN NAMA/NILAI
    return {
        type: 'md',
        ws,
        ev,
